...
python -u main_informer.py --model $model --data ETTh2 --features M --seq_len 48 --label_len 48 --pred_len 24 --e_layers $e_layers --d_layers 1 --attn prob --des 'Exp' --itr 3 --batch_size 16 --mask_rate $mask_rate --des_path $des --loss_lambda $losslambda --train_epochs $train_epoch --patience $patience --l2norm $l2norm --moco_average_pool $moco_average_pool --data_aug $data_aug --cos_lr $cos_lr --learning_rate $learning_rate --mare $mare --time_feature_embed $time_feat --closs_decay $closs_decay
